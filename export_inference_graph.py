...
flags.DEFINE_string('input_type', 'image_tensor', 'Type of input node. Can be '
                    ...
                    '`tf_example`]')
flags.DEFINE_string('pipeline_config_path', 'config/ssd_mobilenet_v1_focal_loss_coco.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', './output/ckp/model.ckpt-21721',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', './output/export_ckp', 'Path to write outputs.')
